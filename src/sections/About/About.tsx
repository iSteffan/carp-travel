  ...
  return (
    <section className={css.section} id="about">
      ...
      >
        ...
        <p
          className="text-gray mb-[20px] w-[180px] text-[14px] font-200 leading-[1.43] 
        ...
        <p
          className="text-gray mb-[40px] w-[180px] text-[14px] font-200 leading-[1.43] 
        ...
        >
          <p
            className="text-[14px] font-400 leading-[1.43] uppercase 
          ...
          <p
            className="text-[14px] text-right font-400 leading-[1.43] uppercase 
          md:text-[16px] md:leading-[1.25] 
          lg:text-[18px] lg:leading-[1.33]"
          >
            to active travelers
          ...
          <p
            className="text-gray font-200 tracking-[-0.14px] 
        ...
        <p
          className="text-gray text-[14px] font-200 leading-[1.43] 
