...
const About = () => {
  return (
    <section className={css.section}>
      ...
      lg:grid-cols-[606px,24px,292px,14px,296px] lg:grid-rows-[16px,104px,136px,24px,192px,72px,72px]"
      >
        <h2
        ...
        lg:col-start-3 lg:col-end-4 lg:row-start-4 lg:row-end-5"
        >
        ...
        >
          <p className="text-[14px] font-normal leading-[1.43] uppercase md:text-[16px] md:leading-[1.25]">
            From vacationers
          </p>
          <p
